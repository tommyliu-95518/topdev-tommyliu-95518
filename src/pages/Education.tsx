	...
	const educationData = [
		{
			...
			location: "Hong Kong, HK, Hong Kong",
			duration: "March 2013 - May 2017",
			degree: "B.Tech (Computer Science and Engineering)",
			grade: "CGPA: 9.23(90%)",
			image: "/education/ad_college.jpg",
			...
			description: "During my time at MU, I have built a strong foundation in computer science, focusing on software development, problem-solving, and real-world applications. Engaging in hands-on projects, internships, and coding challenges has helped me enhance my technical and analytical skills. This experience prepares me for a future in software development, equipping me with the ability to create scalable and efficient solutions."
		}
		// {
